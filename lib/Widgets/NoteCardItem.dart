...
import '../../modules/PharmacyDetails/PharmacyDetails_Model.dart'; // تأكد من مسار الموديل لديك
...
class NoteCardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cardBg = ColorClassHelper().getCardColor(note.noteType);
    final txtColor = ColorClassHelper().getTextColor(note.noteType);
    final tagBg = ColorClassHelper().getTagColor(note.noteType);
