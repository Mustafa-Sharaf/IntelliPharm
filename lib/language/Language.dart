  ...
  Map<String, Map<String, String>> get keys => {
    "en": {
     ...
     • Enhancing user experience and overall application performance.
      ...
      "We are currently calculating the optimal delivery route, please wait...":"We are currently calculating the optimal delivery route, please wait...",
      "Planning is underway":"Planning is underway",
      "Failure to configure the connection path.":"Failure to configure the connection path.",
      "Failed to initialize the connection path.":"Failed to initialize the connection path.",
      "An unexpected error occurred during path setup.":"An unexpected error occurred during path setup.",
      "The delivery route was successfully set up":"The delivery route was successfully set up",
      "The server took a long time to calculate the path. Please try again later.":"The server took a long time to calculate the path. Please try again later.",
      "Path setup failed":"Path setup failed",
      "NoActiveRouteToRePlan":"No Active Route To RePlan",
      "NextLegOptimizedSuccessfully":"Next Leg Optimized Successfully",
      "FailedToRePlanRoute":"Failed To RePlan Route",
      "ErrorOccurredRePlanning":"Error Occurred RePlanning",
      "VisitStatusUpdatedSuccessfully":"Visit Status Updated Successfully",
      "FailedToUpdateStatus":"Failed To Update Status",
      "ErrorOccurredWhileUpdating":"Error Occurred While Updating",
      "An unexpected error occurred during path setup":"An unexpected error occurred during path setup",
      "Failed to parse delivery plan data":"Failed to parse delivery plan data",
      "No active route to re-plan":"No active route to re-plan",
      "Failed to re-plan route":"Failed to re-plan route",
      "Re-planning queued, optimizing route...":"Re-planning queued, optimizing route...",
      "Next leg optimized successfully":"Next leg optimized successfully",
      "An error occurred while re-planning the route":"An error occurred while re-planning the route",
      "Please write a note first.":"Please write a note first.",
      "The message failed to send, please try again later.":"The message failed to send, please try again later.",
      "The note was added successfully.":"The note was added successfully.",
      "The quantity requested is greater than what is available in stock.":"The quantity requested is greater than what is available in stock.",
      "Please select your region first.":"Please select your region first.",
      "Please specify your opening and closing times.":"Please specify your opening and closing times.",
      "Please locate the pharmacy on the map":"Please locate the pharmacy on the map",
      "The pharmacy has been successfully added.":"The pharmacy has been successfully added.",
      "The preservation process failed.":"The preservation process failed.",
      "Please enter the recipient's name":"Please enter the recipient's name",
      "Delivery confirmed successfully":"Delivery confirmed successfully",
      "Delivery confirmation failed":"Delivery confirmation failed",
      "The connection is very slow; the upload took longer than expected.":"The connection is very slow; the upload took longer than expected.",
      ...
      "An unexpected error occurred during the connection.":"An unexpected error occurred during the connection.",
      ...
      "Quantity is 0":"Quantity is 0",
      "dd MMMM yyyy":"dd MMMM yyyy",
      "Failed to process payment":"Failed to process payment",
      "An error occurred while retrieving the pharmacy items,please try again later.":"An error occurred while retrieving the pharmacy items,\n please try again later.",
      "Please select at least one pharmacy":"Please select at least one pharmacy",
      "Please select your travel mode first.":"Please select your travel mode first.",
      "The track is under construction":"The track is under construction",
      "The optimal route is being calculated, please wait...":"The optimal route is being calculated, please wait...",
      "Route creation failed, please try again later.":"Route creation failed, please try again later.",
      "Failed to generate plan":"Failed to generate plan",
      "Location services (GPS) are disabled. Please enable them in your phone's settings.":"Location services (GPS) are disabled. Please enable them in your phone's settings.",
      "Please grant the app access to the location to begin.":"Please grant the app access to the location to begin.",
      "Your live location":"Your live location could not be obtained at this time. Please open Google Maps, make sure your current location is selected, and then return to the app to continue route planning.",
      "Site update required":"Site update required",
      "cancel":"cancel",
      "Open Google Maps":"Open Google Maps",
      "The path was successfully created":"The path was successfully created",
      "Plan creation failed":"Plan creation failed",
      "The Google Maps app could not be opened automatically.":"The Google Maps app could not be opened automatically.",
      "The email address or password is incorrect.":"The email address or password is incorrect.",
      "Logged in successfully, welcome!":"Logged in successfully, welcome!",
      "An error occurred while saving the visit status.":"An error occurred while saving the visit status.",
...
نحن في IntelliPharma نولي أهمية كبيرة لخصوصية بياناتك وحمايتها. تهدف هذه السياسة إلى توضيح كيفية جمع واستخدام بياناتك عند استخدام التطبيق.
     ...
     ''',
      ...
      //AppSnackBar
      "Visit_started_successfully": "تم بدء الزيارة بنجاح.",
      "Failed_to_start_visit": "تعذر بدء الزيارة.",
      "Failed_to_start_visit_please_try_again": "تعذر بدء الزيارة، يرجى المحاولة مرة أخرى.",
      "Logging_out...": "جاري تسجيل الخروج...",
      "We are currently calculating the optimal delivery route, please wait...": "جاري حساب مسار التوصيل الأفضل، يرجى الانتظار...",
      "Planning is underway": "التخطيط قيد التنفيذ",
      "Failure to configure the connection path.": "فشل في إعداد مسار الاتصال.",
      "Failed to initialize the connection path.": "تعذر تهيئة مسار الاتصال.",
      "An unexpected error occurred during path setup.": "حدث خطأ غير متوقع أثناء إعداد المسار.",
      "The delivery route was successfully set up": "تم إعداد مسار التوصيل بنجاح",
      "The server took a long time to calculate the path. Please try again later.": "استغرق الخادم وقتاً طويلاً لحساب المسار، يرجى المحاولة لاحقاً.",
      "Path setup failed": "فشل إعداد المسار",
      "NoActiveRouteToRePlan": "لا يوجد مسار نشط إعادة تخطيطه",
      "NextLegOptimizedSuccessfully": "تم تحسين المرحلة التالية بنجاح",
      "FailedToRePlanRoute": "تعذر إعادة تخطيط المسار",
      "ErrorOccurredRePlanning": "حدث خطأ أثناء إعادة التخطيط",
      "VisitStatusUpdatedSuccessfully": "تم تحديث حالة الزيارة بنجاح",
      "FailedToUpdateStatus": "تعذر تحديث الحالة",
      "ErrorOccurredWhileUpdating": "حدث خطأ أثناء التحديث",
      "An unexpected error occurred during path setup": "حدث خطأ غير متوقع أثناء إعداد المسار",
      "Failed to parse delivery plan data": "تعذر معالجة بيانات خطة التوصيل",
      "No active route to re-plan": "لا يوجد مسار نشط لإعادة التخطيط",
      "Failed to re-plan route": "تعذر إعادة تخطيط المسار",
      "Re-planning queued, optimizing route...": "تمت إضافة إعادة التخطيط للقائمة، جاري تحسين المسار...",
      "Next leg optimized successfully": "تم تحسين المرحلة التالية بنجاح",
      "An error occurred while re-planning the route": "حدث خطأ أثناء إعادة تخطيط المسار",
      "Please write a note first.": "يرجى كتابة ملاحظة أولاً.",
      "The message failed to send, please try again later.": "فشل إرسال الرسالة، يرجى المحاولة لاحقاً.",
      "The note was added successfully.": "تمت إضافة الملاحظة بنجاح.",
      "The quantity requested is greater than what is available in stock.": "الكمية المطلوبة أكبر من المتوفر في المخزون.",
      "Please select your region first.": "يرجى تحديد المنطقه أولاً.",
      "Please specify your opening and closing times.": "يرجى تحديد أوقات الفتح والإغلاق.",
      "Please locate the pharmacy on the map": "يرجى تحديد موقع الصيدلية على الخريطة",
      "The pharmacy has been successfully added.": "تمت إضافة الصيدلية بنجاح.",
      "The preservation process failed.": "فشلت عملية الحفظ.",
      "Please enter the recipient's name": "يرجى إدخال اسم المستلم",
      "Delivery confirmed successfully": "تم تأكيد التوصيل بنجاح",
      "Delivery confirmation failed": "تعذر تأكيد التوصيل",
      "The connection is very slow; the upload took longer than expected.": "الاتصال بطيء جداً، استغرق الرفع وقتاً أطول من المتوقع.",
      "Invalid input data": "بيانات المدخلات غير صالحة",
      "An error occurred while connecting to the server.": "حدث خطأ أثناء الاتصال بالخادم.",
      "An unexpected error occurred during the connection.": "حدث خطأ غير متوقع أثناء الاتصال.",
      "Failed to create order": "تعذر إنشاء الطلب",
      "Order created successfully": "تم إنشاء الطلب بنجاح",
      "Cart is empty": "السلة فارغة",
      "Please select pharmacy": "يرجى اختيار الصيدلية",
      "Added to cart successfully": "تمت الإضافة إلى السلة بنجاح",
      "Not enough stock": "المخزون غير كافٍ",
      "Quantity is 0": "الكمية 0",
      "dd MMMM yyyy": "dd MMMM yyyy",
      "Failed to process payment": "تعذر معالجة عملية الدفع",
      "An error occurred while retrieving the pharmacy items,please try again later.": "حدث خطأ أثناء جلب عناصر الصيدلية،\n يرجى المحاولة لاحقاً.",
      "Please select at least one pharmacy": "يرجى اختيار صيدلية واحدة على الأقل",
      "Please select your travel mode first.": "يرجى تحديد طريقة التنقل أولاً.",
      "The track is under construction":"المسار قيد الإنشاء",
      "The optimal route is being calculated, please wait...": "جاري حساب المسار الأفضل، يرجى الانتظار...",
      "Route creation failed, please try again later.": "تعذر إنشاء المسار، يرجى المحاولة لاحقاً.",
      "Failed to generate plan": "تعذر إنشاء الخطة",
      "Location services (GPS) are disabled. Please enable them in your phone's settings.": "خدمات الموقع (GPS) معطلة. يرجى تفعيلها من إعدادات الهاتف.",
      "Please grant the app access to the location to begin.": "يرجى منح التطبيق صلاحية الوصول إلى الموقع للبدء.",
      "Your live location": "تعذر الحصول على موقعك المباشر حالياً. يرجى فتح خرائط Google، والتأكد من تحديد موقعك الحالي، ثم العودة إلى التطبيق لمتابعة تخطيط المسار.",
      "Site update required": "يتطلب تحديث الموقع",
      "cancel": "إلغاء",
      "Open Google Maps": "فتح خرائط Google",
      "The path was successfully created": "تم إنشاء المسار بنجاح",
      "Plan creation failed": "تعذر إنشاء الخطة",
      "The Google Maps app could not be opened automatically.": "تعذر فتح تطبيق خرائط Google تلقائياً.",
      "The email address or password is incorrect.": "البريد الإلكتروني أو كلمة المرور غير صحيحة.",
      "Logged in successfully, welcome!": "تم تسجيل الدخول بنجاح، أهلاً بك!",
      "An error occurred while saving the visit status.": "حدث خطأ أثناء حفظ حالة الزيارة.",
      "Visit status updated successfully": "تم تحديث حالة الزيارة بنجاح",
      "Please select a region": "يرجى اختيار المنطقة",
      "Please select location": "يرجى تحديد الموقع",
      "Failed to update status, please try again.": "تعذر تحديث الحالة، يرجى المحاولة مرة أخرى.",
      "Visit status updated successfully.": "تم تحديث حالة الزيارة بنجاح.",
      ...
      "Failed_to_cancel_order":"فشل في إلغاء الطلب",
       ...
       //ContactLauncher
      "Choose_a_method_of_communication": "اختر طريقة التواصل",
      "Start_a_live_chat": "بدء محادثة مباشرة",
      "WhatsApp": "واتساب",
